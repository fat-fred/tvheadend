...
static const AVPixelFormat nvenc_h264_levels[] = {
                                  ...
                                  AVDictionary **opts)
{
    ...
    // ------ Set Defaults ---------
    AV_DICT_SET(opts, "b", "2M", 0);
    AV_DICT_SET(opts, "qmin", "-1", 0);
    AV_DICT_SET(opts, "qmax", "-1", 0);
    AV_DICT_SET(opts, "qdiff", "-1", 0);
    AV_DICT_SET(opts, "qblur", "-1", 0);
    AV_DICT_SET(opts, "qcomp", "-1", 0);
    AV_DICT_SET(opts, "g", "250", 0);
...
static const AVPixelFormat nvenc_hevc_levels[] = {
